...
const TimekeeperPercentage = ({ children }) => {
  return (
    <div>
      {children(option)}
    </div>
...
TimekeeperPercentage.defaultProps = {
  data: []
};

TimekeeperPercentage.propTypes = {
  data: PropTypes.array,
  render: PropTypes.func,
};

export default TimekeeperPercentage;
